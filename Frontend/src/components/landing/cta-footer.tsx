...
export const CtaFooter = () => {
  ...
  return (
    <footer ref={containerRef} className="relative w-full bg-black border-t border-white/10 pt-16 flex flex-col items-center z-20">
      
      {/* Massive CTA */}
      <div className="w-full max-w-6xl mx-auto px-4 flex flex-col items-center text-center mb-16">
        <div className="font-mono text-xs text-[#4AF626] mb-8 tracking-[0.2em]">[ SYSTEM.READY ]</div>
      ...
      <div className="w-full border-t border-white/10 bg-[#020617] py-12">
        <div className="max-w-6xl mx-auto px-4 grid grid-cols-1 md:grid-cols-4 gap-12 font-mono text-sm tracking-wider">
          ...
          <div className="flex flex-col gap-4">
            ...
            <a href="#" className="text-gray-500 hover:text-white transition-colors">System Status</a>
            <a href="#" className="text-gray-500 hover:text-white transition-colors">Risk Parameters</a>
          </div>

          <div className="flex flex-col gap-4">
            <span className="text-white font-bold mb-2">LEGAL</span>
            <a href="#" className="text-gray-500 hover:text-white transition-colors">Terms of Execution</a>
            <a href="#" className="text-gray-500 hover:text-white transition-colors">Privacy Protocol</a>
